...
def serializedATN():
    return [
        4,1,44,293,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,
        ...
        30,31,1,0,32,35,1,0,36,37,1,0,38,39,2,0,37,37,40,40,306,0,51,1,0,
        ...
        0,0,101,102,5,41,0,0,102,103,5,3,0,0,103,107,5,4,0,0,104,106,3,2,
        ...
        0,112,117,5,41,0,0,113,114,5,6,0,0,114,116,5,41,0,0,115,113,1,0,
        ...
        1,0,0,0,166,19,1,0,0,0,167,168,5,20,0,0,168,169,5,41,0,0,169,173,
        ...
        30,15,0,196,29,1,0,0,0,197,202,3,32,16,0,198,199,5,28,0,0,199,201,
        ...
        5,29,0,0,207,209,3,34,17,0,208,206,1,0,0,0,209,212,1,0,0,0,210,208,
...
class SynapseParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      ...
                      "STRING_TYPE", "TYPE", "OR", "AND", "EQUAL", "NOT_EQUAL", 
    ...
    def program(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 16630121085444) != 0):
                self.state = 48
                self.statement()
                self.state = 53
                self._errHandler.sync(self)
    ...
    class FuncStatementContext(ParserRuleContext):
        ...
        def DEF(self):
            return self.getToken(SynapseParser.DEF, 0)
    ...
    class TryStatementContext(ParserRuleContext):
        ...
        def TRY(self):
            return self.getToken(SynapseParser.TRY, 0)

        def CATCH(self):
            return self.getToken(SynapseParser.CATCH, 0)
    ...
    def tryStatement(self):
        ...
        try:
            ...
            self.match(SynapseParser.T__4)
            self.state = 99
            self.match(SynapseParser.CATCH)
            self.state = 100
            self.match(SynapseParser.T__1)
            self.state = 101
            self.match(SynapseParser.ID)
    ...
    class LetStatementContext(ParserRuleContext):
        ...
        def LET(self):
            return self.getToken(SynapseParser.LET, 0)
    ...
    class ForStatementContext(ParserRuleContext):
        ...
        def FOR(self):
            return self.getToken(SynapseParser.FOR, 0)

        def ID(self):
            return self.getToken(SynapseParser.ID, 0)

        def IN(self):
            return self.getToken(SynapseParser.IN, 0)
    ...
    def forStatement(self):
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 133
            self.match(SynapseParser.FOR)
            self.state = 134
            self.match(SynapseParser.ID)
            self.state = 135
            self.match(SynapseParser.IN)
            self.state = 136
            self.expr()
            self.state = 137
            self.match(SynapseParser.T__3)
    ...
    class IfStatementContext(ParserRuleContext):
        ...
        def IF(self):
            return self.getToken(SynapseParser.IF, 0)
        ...
        def ELSE(self):
            return self.getToken(SynapseParser.ELSE, 0)
    ...
    class MorphStatementContext(ParserRuleContext):
        ...
        def MORPH(self):
            return self.getToken(SynapseParser.MORPH, 0)
    ...
    def morphStatement(self):
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 167
            self.match(SynapseParser.MORPH)
            self.state = 168
            self.match(SynapseParser.ID)
            self.state = 169
            self.match(SynapseParser.T__3)
    ...
    class GoalStatementContext(ParserRuleContext):
        ...
        def GOAL(self):
            return self.getToken(SynapseParser.GOAL, 0)
    ...
    class ExprContext(ParserRuleContext):
        ...
        def orExpr(self):
            return self.getTypedRuleContext(SynapseParser.OrExprContext,0)
    ...
    def expr(self):
        ...
        localctx = SynapseParser.ExprContext(self, self._ctx, self.state)
    ...
    class OrExprContext(ParserRuleContext):
        ...
        def andExpr(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(SynapseParser.AndExprContext)
            else:
                return self.getTypedRuleContext(SynapseParser.AndExprContext,i)


        def OR(self, i:int=None):
            if i is None:
                return self.getTokens(SynapseParser.OR)
            else:
                return self.getToken(SynapseParser.OR, i)

        def getRuleIndex(self):
            return SynapseParser.RULE_orExpr
    ...
    def orExpr(self):
        ...
        localctx = SynapseParser.OrExprContext(self, self._ctx, self.state)
    ...
    class AndExprContext(ParserRuleContext):
        ...
        def eqExpr(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(SynapseParser.EqExprContext)
            else:
                return self.getTypedRuleContext(SynapseParser.EqExprContext,i)


        def AND(self, i:int=None):
            if i is None:
                return self.getTokens(SynapseParser.AND)
            else:
                return self.getToken(SynapseParser.AND, i)

        def getRuleIndex(self):
            return SynapseParser.RULE_andExpr
    ...
    def andExpr(self):
        ...
        localctx = SynapseParser.AndExprContext(self, self._ctx, self.state)
    ...
    class EqExprContext(ParserRuleContext):
        ...
        def relExpr(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(SynapseParser.RelExprContext)
            else:
                return self.getTypedRuleContext(SynapseParser.RelExprContext,i)


        def EQUAL(self, i:int=None):
            if i is None:
                return self.getTokens(SynapseParser.EQUAL)
            else:
                return self.getToken(SynapseParser.EQUAL, i)

        def NOT_EQUAL(self, i:int=None):
            if i is None:
                return self.getTokens(SynapseParser.NOT_EQUAL)
            else:
                return self.getToken(SynapseParser.NOT_EQUAL, i)

        def getRuleIndex(self):
            return SynapseParser.RULE_eqExpr
    ...
    def eqExpr(self):
        ...
        localctx = SynapseParser.EqExprContext(self, self._ctx, self.state)
    ...
    class RelExprContext(ParserRuleContext):
        ...
        def addExpr(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(SynapseParser.AddExprContext)
            else:
                return self.getTypedRuleContext(SynapseParser.AddExprContext,i)


        def GREATER(self, i:int=None):
            if i is None:
                return self.getTokens(SynapseParser.GREATER)
            else:
                return self.getToken(SynapseParser.GREATER, i)

        def LESS(self, i:int=None):
            if i is None:
                return self.getTokens(SynapseParser.LESS)
            else:
                return self.getToken(SynapseParser.LESS, i)

        def GREATER_EQUAL(self, i:int=None):
            if i is None:
                return self.getTokens(SynapseParser.GREATER_EQUAL)
            else:
                return self.getToken(SynapseParser.GREATER_EQUAL, i)

        def LESS_EQUAL(self, i:int=None):
            if i is None:
                return self.getTokens(SynapseParser.LESS_EQUAL)
            else:
                return self.getToken(SynapseParser.LESS_EQUAL, i)

        def getRuleIndex(self):
            return SynapseParser.RULE_relExpr
    ...
    def relExpr(self):
        ...
        localctx = SynapseParser.RelExprContext(self, self._ctx, self.state)
    ...
    class AddExprContext(ParserRuleContext):
        ...
        def mulExpr(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(SynapseParser.MulExprContext)
            else:
                return self.getTypedRuleContext(SynapseParser.MulExprContext,i)


        def PLUS(self, i:int=None):
            if i is None:
                return self.getTokens(SynapseParser.PLUS)
            else:
                return self.getToken(SynapseParser.PLUS, i)

        def MINUS(self, i:int=None):
            if i is None:
                return self.getTokens(SynapseParser.MINUS)
            else:
                return self.getToken(SynapseParser.MINUS, i)

        def getRuleIndex(self):
            return SynapseParser.RULE_addExpr
    ...
    def addExpr(self):
        ...
        localctx = SynapseParser.AddExprContext(self, self._ctx, self.state)
    ...
    class MulExprContext(ParserRuleContext):
        ...
        def unaryExpr(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(SynapseParser.UnaryExprContext)
            else:
                return self.getTypedRuleContext(SynapseParser.UnaryExprContext,i)


        def MULT(self, i:int=None):
            if i is None:
                return self.getTokens(SynapseParser.MULT)
            else:
                return self.getToken(SynapseParser.MULT, i)

        def DIV(self, i:int=None):
            if i is None:
                return self.getTokens(SynapseParser.DIV)
            else:
                return self.getToken(SynapseParser.DIV, i)

        def getRuleIndex(self):
            return SynapseParser.RULE_mulExpr
    ...
    def mulExpr(self):
        ...
        localctx = SynapseParser.MulExprContext(self, self._ctx, self.state)
    ...
    class UnaryExprContext(ParserRuleContext):
        ...
        def MINUS(self):
            return self.getToken(SynapseParser.MINUS, 0)

        def NOT(self):
            return self.getToken(SynapseParser.NOT, 0)

        def getRuleIndex(self):
            return SynapseParser.RULE_unaryExpr
    ...
    def unaryExpr(self):
        ...
        localctx = SynapseParser.UnaryExprContext(self, self._ctx, self.state)
    ...
    class PrimaryContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return SynapseParser.RULE_primary
    ...
    def primary(self, _p:int=0):
        ...
        localctx = SynapseParser.PrimaryContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 44
